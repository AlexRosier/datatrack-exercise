...
from src.integrated_exercise.clean.raw_reader import category_fields
...
def test_transform():
    ...
    fields = [
        ...
        StructField("station_coordinates_x", FloatType()),
        StructField("station_coordinates_y", FloatType()),
    ...
    df_expected = spark.createDataFrame(
        [
            (1030, "40AL01 - Linkeroever", "Feature", 6151, "1", "IRCEL - CELINE: timeseries-api (SOS 2.0)", "6151",
             ...
             "6151 - Unknown device - procedure", "391", "Black Carbon", "391", "Black Carbon", 4.385223684454717,
             51.23619419990248, None, "Point", date),
            (1030, "40AL01 - Linkeroever", "Feature", 6152, "1", "IRCEL - CELINE: timeseries-api (SOS 2.0)", "6152",
             ...
             "Particulate Matter < 10", 4.385223684454717, 51.23619419990248, None, "Point", date),
            (1031, "40AL02 - Beveren", "Feature", 6153, "1", "IRCEL - CELINE: timeseries-api (SOS 2.0)", "6153",
             ...
             4.234832753144059, 51.30452079034428, None, "Point", date)
        ],
